...
public class StringUtils {
    ...
    */
     ...
     */
     ...
     public static String settleContent(String body) {
       if (body==null) { return new String(""); }

       StringBuffer buf = new StringBuffer(body.length()*2);
     ...
     public static String loadFromFile(String fileName) {
       ...
       return settleContent(resultString.toString()) ;
     }

     public static String convertChinese(String in)
     {
       String s = null;
       byte temp [];
       if (in == null) {
