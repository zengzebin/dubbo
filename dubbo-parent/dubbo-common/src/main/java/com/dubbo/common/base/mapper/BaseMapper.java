package com.dubbo.common.base.mapper;
...
public interface BaseMapper<TExample,Pojo> {
     ...
     * @return
     */
    List<Pojo> selectByExample(TExample example);
     ...
     * @return
     */
    int updateByExampleSelective(@Param("record") Pojo record, @Param("example") TExample example);
     ...
     * @return
     */ 
    int updateByExample(@Param("record") Pojo record, @Param("example") TExample example);
